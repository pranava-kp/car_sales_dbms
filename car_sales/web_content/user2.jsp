...
<div class="content-container">
    <h2>Current Car Models Mileage</h2>
    <%
    ...
    <%
        ...
        try {
            ...
            String sql = "SELECT DISTINCT m.Model_Name, c.Mileage, m.Year_of_prod FROM CAR c JOIN MODEL m ON c.Model_ID = m.ID WHERE c.Mileage > (     SELECT AVG(c2.Mileage)     FROM CAR c2     JOIN MODEL m2 ON c2.Model_ID = m2.ID     WHERE m2.Manufacturer_Name = m.Manufacturer_Name );";
            ...
            out.println("<table>");
            out.println("<tr><th>Model Name</th><th>Mileage</th><th>Year Of Production</th></tr>");

            while (rs.next()) {
                String column1 = rs.getString("Model_Name");
                String column2 = rs.getString("Mileage");
